    ...
    return (
        <><footer className="footer sm:footer-horizontal bg-base-200 text-base-content p-10">
            ...
            <nav>
                ...
                <a className="link link-hover">Composants pre-style</a>
                <a className="link link-hover">Calcul de statistique github</a>
            </nav>
            <nav>
                <h6 className="footer-title">Contributeurs</h6>
            ...
            <nav>
                <h6 className="footer-title">Contribuer</h6>
                <a className="link link-hover">Github</a>
                <a className="link link-hover">Licence</a>
